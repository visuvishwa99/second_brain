- spark streaming ^663d6ac3-8fa6-465b-8695-055d9f8ea55e
	- Streaming Aggregates and State Store ^663d6cc9-ae7f-4bb0-ba84-3ff0223b0e6f
	  collapsed:: true
		- outputMode:complete
			- Syntax for outputmode in sparkstreaming {{c1 outputMode("complete")}} and is similar to {{c2 full load}} ^663d7441-f0ab-4907-b384-c28cd8480f1b
				- Ex:
	...
	- Incremental Aggregates and Update Mode
	  collapsed:: true
		- outputMode:update
		- updata method needs {{c1 foreachbatch}} and {{c2 upsert}} ^663d7cac-bc33-4566-8ab4-92f8332c0271
		- syntax is {{c3 foreachBatch(self.upsert)}} ^663d7cfb-ce4b-4e1a-a2ef-b273cec2a634
			- ```python
