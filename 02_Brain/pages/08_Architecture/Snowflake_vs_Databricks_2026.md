...
```mermaid
flowchart LR
    classDef databricks fill:#ff7675,stroke:#d63031,stroke-width:2px,color:#fff
    classDef snowflake fill:#74b9ff,stroke:#0984e3,stroke-width:2px,color:#fff
    classDef storage fill:#55efc4,stroke:#00b894,stroke-width:2px,color:#fff
