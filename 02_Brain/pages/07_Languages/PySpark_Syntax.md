		...
		- Use dot notation:
		 ...
		 df.select(
		 	...
		 	from pyspark.sql.functions import expr
		 	 ...
		 	 a Schema for Complex Types . Nested
	 ...
	 id:: 681176f4-7e12-42c1-b44b-1e3dd504dff1
		- first("column"):
			- ```python
			 ...
			 collect_list: [85000, 92000, 78000, 105000, 67000, 85000] s all occurrences
			 ```
			 collect_set:
			 ```python
...
- How do you replace characters in string columns? ^680b088b-29a4-4db5-bd49-d690ed9fed08
	-
		- Using translate:
		 ```python
		 translate() function performs "character-by-character" substitution according to a mapping:
...
- How do you create map-type columns from existing columns? ^680b088b-f19f-4f87-bc49-7e66de124418
	-
		- Using create_map:
		 ...
		 all values as StringType (simplest)
		 schema = StructType([
		 StructField("name", StringType(), True),
