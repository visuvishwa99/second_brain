...
3. **Audit Lineage**: Verify the consistency of `agents/movement_log.md`.
...
To trigger a maintenance audit, run the orchestrator script:
...
- [audit_report.md](file:///c:/Misc/Dataengineering/Projects/build_second_brain/agents/audit_report.md)
